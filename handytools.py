...
session_shoper.headers.update({
    'User-Agent': 'Handytools/1.0 (+https://github.com/pwalczak418/shoperapi-handytools; https://pwalczak.net)',
...
def delete_attributes(): #Up to 50 for this version
    att__url = url + "attributes"
    gr_att_url = url + "attribute-groups"
    response1 = session_shoper.get(att__url, params={"limit": 50})
    ...
    for item in data1["list"]:
        ...
        session_shoper.delete(f"{att__url}/{att_id}")
        time.sleep(1)
